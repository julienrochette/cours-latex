...
\begin{Maquette}[IE]{
        Numero = 3, Code={}, Date = lundi 1\textsuperscript{er}
 décembre, Theme = Théorème de Thalès / Automatismes, Calculatrice = true
    }
    ...
    \begin{exercice}
        ...
        \begin{multicols}{2}
            ...
            \begin{center}
                \includegraphics[width = .85\linewidth]{Images/Évaluation 3 -semblables2.png}
            \end{center}
        \end{multicols}
    \end{exercice}
