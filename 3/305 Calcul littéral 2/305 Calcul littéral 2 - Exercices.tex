...
\begin{multicols}{2}
    ...
    \begin{Maquette}[Fiche]{Theme=Calcul littéral 2, Niveau=Troisième}
        ...
        \begin{exercice}
            \begin{enumerate}
                \item Détermine la valeur de $x$ sachant que les périmètres des deux rectagles sont égaux. 
                \begin{center}
                    \includegraphics[width=\linewidth]{images/perimetre.png}
                \end{center}

                \item Détermine la valeur de $x$ sachant que l’aire du carré est égale à l’aire du rectangle.
                 \begin{center}
                    \includegraphics[width=\linewidth]{images/aires.png}
                \end{center}    
            \end{enumerate}
        \end{exercice}
    \end{Maquette}
