...
\newcolumn
   ...
   \begin{exercice}
      ...
      La figure suivante n’est pas à l’échelle. On sait que :
      \begin{itemize}
         \item les points M, A et S sont alignés
         \item les points M, T et H sont alignés
         \item MH = \Lg{5}, MS = \Lg{13}, MT = \Lg{7}
      \end{itemize}
      \begin{center}
         \includegraphics[width=.7\linewidth]{Images/ex14.png}
      \end{center}

      \begin{enumerate}
         \item Démontrer que la longueur HS est égale à \Lg{12}.
         ...
         \begin{itemize}
            ...
            \item une homothétie
         \end{itemize}
         \item Sachant que la longueur MT est 1,4 fois plus grande que la longueur MH, un élève affirme :
         \begin{center}
            « L’aire du triangle MAT est 1,4 fois plus grande que l’aire du triangle MHS. »
         \end{center}
         \item[] Cette affirmation est-elle vraie ?
      \end{enumerate}
   \end{exercice}
\end{Maquette}
