...
\begin{Maquette}[IE]{
    ...
    \begin{exercice}
        ...
        \begin{enumerate}
            ...
            \item Sachant qu’il y avait initialement 6 lapins, y avait-il plus ou moins de cinq millions de lapins après un an ? (on suppose, de manière simpliste, qu’il n’y a eu aucun décès de lapin durant cette période)
        \end{enumerate}
    \end{exercice}
\end{multicols}
